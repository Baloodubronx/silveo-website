...
$(document).ready(function() {
  ...
  TweenLite.from("#title-one", 1.5, {opacity:0, delay:1});
  TweenLite.from("#title-two", 1, {opacity:0, fontSize:10, delay:2});
  TweenLite.from("#bg-one", 2, {opacity:0, delay:3});
...
$(document).on('scroll', function(){
  ...
  if (position < windowHeight) {
    ...
    TweenLite.to("#navbar", 0.3, {opacity:1});
  }
